...
__export(index_exports, {
  ...
  createAppLayout: () => createAppLayout
});
...
function createAppLayout({ version, userMenuItems } = {}) {
  ...
  const CustomAppBar = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react_admin.AppBar, { userMenu: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CustomUserMenu, {}), children: [
  ...
  return (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_admin.Layout, { ...props, appBar: CustomAppBar });
}
